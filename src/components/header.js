...
<label htmlFor="check" className='check'><i class="fas fa-bars-staggered fs-4"></i></label>
<input type="checkbox" onClick={handleShow} name="noname" id="check" className='d-none input' />
<div className={classe.clas}>
<NavLink to="/form" className="mobile">Form</NavLink>
<NavLink to="/api" className="mobile">API</NavLink>
<NavLink to="/counter" className="mobile">Counter</NavLink>
</div>
</div>
<div className="liens">
